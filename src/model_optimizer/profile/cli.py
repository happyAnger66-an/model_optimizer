...
def profile_onnx(model_path, output_dir, is_e2e=False, is_layer=False):
    ...
    print(f'is_e2e {is_e2e}, is_layer {is_layer}')
    if is_e2e:
...
def profile_cli(args):
    ...
    profile_onnx(args.model_path, args.output_dir, args.e2e_profile, args.layer_profile)