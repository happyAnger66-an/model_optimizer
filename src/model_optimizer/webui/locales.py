...
LOCALES = {
    "title": {
        "en": {
            "value": "<h1><center>🦙🏭Model Factory: Unified Efficient Fine-Tuning of 100+ LLMs</center></h1>",
        },
        "ru": {
            "value": "<h1><center>🦙🏭Model Factory: Унифицированная эффективная тонкая настройка 100+ LLMs</center></h1>",
        },
        "zh": {
            "value": "<h1><center>🦙🏭Model Factory: 模型高效量化部署平台</center></h1>",
        },
        "ko": {
            "value": "<h1><center>🦙🏭Model Factory: 100+ LLMs를 위한 통합 효율적인 튜닝</center></h1>",
        },
        "ja": {
            "value": "<h1><center>🦙🏭Model Factory: 100+ LLMs の統合効率的なチューニング</center></h1>",
        },
    },
    "subtitle": {
        "en": {
            "value": (
                "<h3><center>Visit <a href='https://github.com/hiyouga/Model-Factory' target='_blank'>"
        ...
        "ru": {
            "value": (
                "<h3><center>Посетить <a href='https://github.com/hiyouga/Model-Factory' target='_blank'>"
        ...
        "zh": {
            "value": (
                "<h3><center>访问 <a href='https://github.com/hiyouga/Model-Factory' target='_blank'>"
        ...
        "ko": {
            "value": (
                "<h3><center><a href='https://github.com/hiyouga/Model-Factory' target='_blank'>"
