    ...
    FmhaD256Params const& p, cudaStream_t stream, bool useFp16)
{
    if (useFp16)
    {
        fmha_d256_homo_fp16_Tensor_q_t q{};
        fmha_d256_homo_fp16_Tensor_kv_t kv{};
        fmha_d256_homo_fp16_Tensor_o_t o{};
        fmha_d256_homo_fp16_Tensor_cu_kv_t cu{};
        ...
        return cute_dsl_fmha_d256_homo_fp16_wrapper(
            &sModuleFp16, &q, &kv, &o, &cu, stream);
    }

    fmha_d256_homo_bf16_Tensor_q_t q{};
    fmha_d256_homo_bf16_Tensor_kv_t kv{};
    fmha_d256_homo_bf16_Tensor_o_t o{};
    fmha_d256_homo_bf16_Tensor_cu_kv_t cu{};
